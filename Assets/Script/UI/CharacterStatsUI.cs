...
public class CharacterStatsUI : MonoBehaviour
{
    ...
    private void UpdateStats()
    {
        ...
        CreateStatText("Attack", characterStats.Atk.ToString("F1"));
        ...
        CreateStatText("Crit DMG", characterStats.CritDamage.ToString("F1") + "%");
        CreateStatText("Armor Pierce", characterStats.ArmorPierce.ToString("F1") + "%");
        CreateStatText("Life Steal", characterStats.LifeSteal.ToString("F1") + "%");
